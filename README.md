...
```
 bash -c "$(curl -L https://raw.githubusercontent.com/MohammadS3dd/xray-reality/master/install.sh)"
``` 
and it will do the rest for you.

## Uninstallation guide
```
 bash -c "$(curl -L https://raw.githubusercontent.com/MohammadS3dd/xray-reality/master/uninstall.sh)"
``` 
...
``` bash
git clone https://github.com/MohammadS3dd/xray-reality && cd xray-reality
```
